...
public class OreGeneration {
	...
	public static void registerOres() {
		ConfiguredFeature<?, ?> enderiteOre = Feature.ORE.configured(new OreConfiguration(
				List.of(OreConfiguration.target(END_TEST, BlockInit.ENDERITE_ORE.get().defaultBlockState())), 2))
				.rangeUniform(VerticalAnchor.absolute(10), VerticalAnchor.absolute(15))
				.squared().count(1);
